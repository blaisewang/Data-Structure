...
template<class K, class E>
pair<const K, E> *indexedBinarySearchTree<K, E>::find(const K &theKey) const { // Return pointer to matching pair.
...
template<class K, class E>
void indexedBinarySearchTree<K, E>::insert(const pair<const K, E> &thePair) { // Insert thePair into the tree. Overwrite existing

...
//{
//	chainNode<T> *currentNode = headerNode->next;
//	stackWithArrayList<T> tempStack;
//
//	while (currentNode != headerNode)
//	{
//		tempStack.push(currentNode->element);
//		currentNode = currentNode->next;
//	}
//
...
//	{
//		currentNode->element = tempStack.top();
//		tempStack.pop();
//		currentNode = currentNode->next;
//	}
//}
...
{
	chainNode<T> *currentNode = headerNode->next;
	circularListWithHeader<T> tempList;

	while (currentNode != headerNode)
	{
		tempList.insert(0, currentNode->element);
		currentNode = currentNode->next;
	}
	...
	while (tempList.size())
	{
		currentNode->element = tempList.get(0);
		tempList.erase(0);
		currentNode = currentNode->next;
	}
}
